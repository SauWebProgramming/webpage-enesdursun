  ...
  <body>
		<?php
			include 'header.php';
		?>
<form style="padding-top:100px;" class="form-horizontal container" action="slideradd.php" method="post">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default">Slider Ekle</button>
    </div>
  </div>
</form>
  </body>
